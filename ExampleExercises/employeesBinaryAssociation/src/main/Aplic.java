...
import fatec.poo.model.Project;
...
public class Aplic {
    ...
    public static void main(String[] args) {
        ...
        Department dpto = new Department("FN", "Finances");
        Project prj = new Project(0001, "API configuration");
        
        dpto.addEmployee(ce);
        ce.setDepartment(dpto);
        ...
        System.out.println("\n\nO funcionario " + ce.getName() + " esta alocado no departamento " + ce.getDepartament().getName() + " e no projeto " + ce.getProject().getDescription());
        System.out.println("O funcionario " + he.getName() + " esta alocado no departamento " + he.getDepartament().getName() + " e no projeto " + he.getProject().getDescription());
    }  
}
